        ...
        {selectedImg && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 md:p-10">
            <motion.div
              ...
              className="absolute inset-0 bg-lotus-dark-blue/40 backdrop-blur-2xl"
            />

            <motion.div
              layoutId={`img-${selectedImg.id}`}
              className="relative w-full bg-lotus-lavander/40 max-w-6xl h-[70vh] md:h-[85vh] z-10 overflow-hidden rounded-xl shadow-2xl"
            >
              <Image
                src={selectedImg.src}
