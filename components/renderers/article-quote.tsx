...
export default function ArticleQuote({ data }: { data: QuoteComponent }) {
  const { text, author, authorDescription, authorDates } = data;

  return (
    <section className="w-full py-16 md:py-24 px-6">
      <div className="mx-auto relative bg-lotus-dark-blue/40 backdrop-blur-lg rounded-3xl p-10 md:p-16 border border-lotus-bronze/30 shadow-2xl overflow-hidden">
